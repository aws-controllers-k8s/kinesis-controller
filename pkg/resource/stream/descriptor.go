...
const (
	FinalizerString = "finalizers.kinesis.services.k8s.aws/Stream"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("streams")
