...
const (
	FinalizerString = "finalizers.kinesis.services.k8s.aws/StreamConsumer"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("streamconsumers")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.StreamConsumer{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.StreamConsumer),
	}
}
